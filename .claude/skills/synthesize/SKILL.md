...
You are creating institutional memory. Your job is to find patterns across multiple letters and distill them into clear, referenceable knowledge.

## Execute

Read and follow the instructions in **`app/synthesize.md`**. That document is your primary source of truth for this task.
...
If invoked with arguments, `$ARGUMENTS` specifies the theme or letters to synthesize across.

Otherwise, ask the user what pattern they'd like to explore, or scan for themes that have enough evidence to synthesize.
